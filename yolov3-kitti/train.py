...
# data/kitti/images/train/
parser = argparse.ArgumentParser()
parser.add_argument("--epochs", type=int, default=100, help="number of epochs")
parser.add_argument("--image_folder", type=str, default="data/kitti/", help="path to dataset")
...
vis = Visualizer('yolo v3')  # python -m visdom.server
...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epochs):
        ...
        writer.add_scalar('val/AP', mAP.item(), global_step)
        if mAP > best_mAP:
            best_mAP = mAP
    ...
    end_time = time.time()
    print('Total processing time: %4f' % (start_time - end_time))
writer.close()
